 CREATE DATABASE VideoGameLibraryMa;
...
CREATE TABLE GAME (
	...
	gameMfr INT NOT NULL CONSTRAINT fkGameMfr FOREIGN KEY REFERENCES MANUFACTURER(mfrID) ON UPDATE CASCADE ON DELETE CASCADE,
	gameConsole INT NOT NULL CONSTRAINT fkGameConsole FOREIGN KEY REFERENCES CONSOLE(consoleID) ON UPDATE CASCADE ON DELETE CASCADE,
	gameGenre INT NOT NULL CONSTRAINT fkGameGenre FOREIGN KEY REFERENCES GENRE(genreID) ON UPDATE CASCADE ON DELETE CASCADE,
	gameEsrb INT NOT NULL CONSTRAINT fkGameEsrb FOREIGN KEY REFERENCES ESRB(esrbID) ON UPDATE CASCADE ON DELETE CASCADE,
	gameGIScore INT NOT NULL CONSTRAINT fkGameGIScore FOREIGN KEY REFERENCES GISCORE(giScoreID) ON UPDATE CASCADE ON DELETE CASCADE,
	gamePerScore INT NOT NULL CONSTRAINT fkGamePerScore FOREIGN KEY REFERENCES PERSONAL_SCORE(perScoreID) ON UPDATE CASCADE ON DELETE CASCADE,
	gamePub INT NOT NULL CONSTRAINT fkGamePub FOREIGN KEY REFERENCES PUBLISHER(pubID) ON UPDATE CASCADE ON DELETE CASCADE,
	gameDev INT NOT NULL CONSTRAINT fkGameDev FOREIGN KEY REFERENCES DEVELOPER(devID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE COPIES (
	gameID INT CONSTRAINT fkCopiesGameID FOREIGN KEY REFERENCES GAME(gameID) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE LOANS (
	gameID INT CONSTRAINT fkLoansGameID FOREIGN KEY REFERENCES GAME(gameID) ON UPDATE CASCADE ON DELETE CASCADE,
	ownerID INT NOT NULL CONSTRAINT fkCopiesOwnerID FOREIGN KEY REFERENCES OWNER_BRANCH(ownerID),
